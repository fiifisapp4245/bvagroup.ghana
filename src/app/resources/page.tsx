...
export default function ResourcesPage() {
  return (
    <>
      ...
      <section className="relative min-h-[100svh] flex flex-col">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, rgba(13,51,32,0.97) 0%, rgba(13,51,32,0.65) 30%, transparent 60%)',
            }}
          />
        </div>
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end pb-16 lg:pb-24 pt-16">
          <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
            <p className="text-green-400/60 text-[11px] uppercase tracking-[0.28em] mb-6 font-medium">
              BVA Resources · Ghana
            </p>
            <h1
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-10 max-w-[520px]">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-12 gap-8 mb-16">
            <div className="col-span-12 lg:col-span-5">
              <p className="text-green-400/50 text-[10px] uppercase tracking-[0.25em] mb-4 font-medium">
                Our Operations
              </p>
              <h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {scopeItems.map(({ number, title, description }) => (
              <div
                key={number}
                className="bg-[#0d3320] rounded-2xl p-8 border border-green-900/40"
              >
                <div className="font-heading font-bold text-green-400/25 text-5xl leading-none mb-8 select-none">
                  {number}
                </div>
            ...
            <div className="col-span-12 lg:col-span-5 order-2 lg:order-1">
              ...
              <div className="grid grid-cols-2 gap-4 mb-10">
                {[
                  ...
                  { label: 'Region', value: 'Eastern, GH' },
                  { label: 'Stage', value: 'Exploration' },
                  { label: 'Concession', value: 'TBC' },
                ].map(({ label, value }) => (
                  <div key={label} className="bg-[#0a2a18] rounded-xl p-4 border border-green-900/30">
                    <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mb-1.5">
                      {label}
                    </div>
                    <div className="text-white font-heading font-bold text-base">{value}</div>
                  </div>
                ))}
              </div>
            ...
            <div className="col-span-12 lg:col-span-7 order-1 lg:order-2">
              <div className="relative h-[420px] lg:h-[560px] rounded-2xl overflow-hidden">
                ...
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(to top, rgba(13,51,32,0.7) 0%, transparent 50%)',
                  }}
                />
              </div>
            </div>
      ...
      <section className="bg-[#0a0a0a] py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <p className="text-green-400/50 text-[10px] uppercase tracking-[0.25em] mb-14 font-medium">
            Our Approach
          </p>
          <div className="grid grid-cols-12 gap-8 lg:gap-10">
            {approaches.map(({ number, title, description }) => (
              <div key={number} className="col-span-12 md:col-span-4">
                <div className="font-heading font-bold text-white/8 text-7xl leading-none mb-7 select-none">
                  {number}
                </div>
                <h3
                  className="font-heading font-bold text-white leading-snug mb-4"
