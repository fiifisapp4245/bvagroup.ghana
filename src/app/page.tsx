...
export default function HomePage() {
  return (
    <>
      ...
      <section className="relative min-h-[100svh] flex flex-col">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <Image
            ...
            alt="BVA Group development"
            fill
            className="object-cover object-center"
            priority
          />
          {/* Very light top feather — nav link readability only */}
          <div
          ...
          />
          {/* Bottom gradient — only where text sits, image is clear above */}
          <div
            className="absolute inset-0"
            style={{
              background:
      ...
      {/* ── 2. STAT BAR ─────────────────────────────────────────── */}
      {/*
        Titan pattern: compact horizontal row of numbers, sits just below hero.
        Dividers between each stat, consistent padding.
      */}
      ...
      {/* ── 3. PROPERTIES ───────────────────────────────────────── */}
      {/*
        Titan pattern: white section bg, text left (5 cols), large rounded
        card panel right (7 cols). Text col has eyebrow → H2 → body → CTA.
      */}
      ...
      {/* ── 4. RESOURCES ────────────────────────────────────────── */}
      {/*
        Titan pattern: alternate section bg (light gray), reverse column order —
        large panel left (7 cols), text right (5 cols).
      */}
      ...
      <section className="bg-[#f7f7f5] py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {/* Advisor card grid — click + to reveal details, name/title below each card */}
      ...
      {/* ── 6. WHY BVA ──────────────────────────────────────────── */}
      {/*
        Titan pattern: single dark "statement" section mid-page.
        3-column principle grid within the 12-col container.
      */}
      <section className="bg-white py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      {/* ── 7. CONTACT BAND ─────────────────────────────────────── */}
      {/*
        Titan pattern: dark section, text left (7 cols), CTAs right (5 cols).
      */}
